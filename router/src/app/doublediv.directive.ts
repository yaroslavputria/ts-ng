import { Directive, HostBinding, ElementRef, Renderer2, HostListener, Input, TemplateRef, ViewContainerRef, OnDestroy, SimpleChanges } from "@angular/core";
...
export class DoubleDivDirective implements OnDestroy {
    ...
    constructor(private el: ElementRef, private vc: ViewContainerRef, re: Renderer2) {
